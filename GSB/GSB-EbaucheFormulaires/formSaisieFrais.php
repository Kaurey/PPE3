...
<div name="droite" style="float:left;width:80%;">
	...
	<form name="formSaisieFrais" method="post" action="enregSaisieFrais.php">
		...
		<label class="titre">PERIODE D'ENGAGEMENT :</label>
			...
			<label style="float:left;">&nbsp;Année (4 chiffres) : </label><input type="text" size="4" name="FRA_AN" class="zone" type="date" id="annee" value="<?php echo date('Y')?>"/>
			<?php /*
			<script type="text/javascript">
				...
				document.getElementById('annee').value=todayannee;
			</script>
			*/?>
